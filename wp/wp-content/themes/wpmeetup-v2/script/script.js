jQuery(document).ready(function($){
	...
	var counter=1;
        $('.contentstart .box').each(function(){
           if(counter % 3==0){ // Die '6' durch Ihre Zahl ersetzen
             $(this).css('margin-right','0'); // Margin nach rechts wird entfernt
           }
            counter++;
        });
		$(".modulbox .post-439").css({ opacity: 0.5 });
		
		$(".modulbox .post-441").css({ opacity: 0.5 });
		
		$("li.menu-item-227").click(function(){
